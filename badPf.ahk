_.start({"packageName":"badPf", "version":"1", "url":"https://raw.githubusercontent.com/m-ood/badPf/main/badPf.as", "passwordProtected":"0"})
global $:=_.params({"1_sens":"0.05099","2_empSlide":"n","3_gunMacro":"five-0"})
;#if ((!winactive("ahk_exe code.exe")))
{
    ...
    obj:=_.keybind.macro(,$.3_gunMacro,"main")
    ;obj:=_.keybind.macro(,"$*+k","main")
                ...
                class __tbd extends _ {
                    ...
                    __new(port) {
                        ...
                        ;/setup struct
                            ...
                            sockAddrInStruct.sin_addr.s_addr:=inet_addr("127.0.0.1")
...
;---{"data": {"params": {"1_sens": "0.05099", "2_empSlide": "n", "3_gunMacro": "five-0"}}, "ID": "c215049d-7c73-43a8-a6d2-74d1e623831a
;---", "TIME": "20240408143752436"}
*/